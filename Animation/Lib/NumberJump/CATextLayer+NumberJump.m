...
- (void)jumpNumberWithDuration:(float)duration
...
- (void)initPoints {
    ...
    for (int i = 0; i < kPointsNumber; i++) {
        ...
        [numberPoints addObject:[NSArray arrayWithObjects:[NSNumber numberWithFloat:durationTime], [NSNumber numberWithFloat:value], nil]];// 持续时间和Value
    }
}
